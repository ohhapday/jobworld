...
<head>
	...
	<script src="/bower_components/requirejs/require.js" data-main="/dist/js/admin/main_2.js"></script>
...
<div id="container">
	<div id="content" class="clfix">
		<div class="sbleftcol3 clfix adm">
			<div class="sb_tit">
				<h3 class="ic7">로그인 및 체험자 정보</h3>
			</div>
			<div class="box_tbllist margnon">
				<table>
					<colgroup>
						<col style="width: 33%;">
						<col style="width: 33%;">
		...
		<div class="sbleftcol1 clfix adm">
			...
			<div class="sbleftdat">
				<div class="bx_chk_list clfix">
					<ul>
						<li class="fs">
							<button type="button" class="on">투자성향</button>
						</li>
						<li class="bg1">
							<div>
		...
		<div class="sbleftcol2 clfix">
			<div class="sb_tit">
				<h3 class="ic2">환경설정 및 관리</h3>
			</div>
			<div class="sbrightdat">
			...
			<div class="box_tbllist col2fr hidden">
				<table>
					...
					<tr class="hidden">
						...
						<td>01</td>
						<td>
							<input type="text" name="code" style="width: 97%;" title="">
						</td>
					</tr>
					</tbody>
				</table>
		...
		<div class="box_contpop">
			...
			<div class="box_tbllist mt30">
				<table>
					...
					<tr>
						<td>
							<input type="text" style="width: 100%" placeholder="제목">
