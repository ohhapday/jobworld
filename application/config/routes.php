...
$route['admin']['POST'] = 'admin/post_admin';
...
$route['main/data']['POST'] = 'main/post_data';
$route['main/data']['GET'] = 'main/get_data';
$route['main/data']['PUT'] = 'main/put_data';
$route['main/data']['DELETE'] = 'main/delete_data';